...
const UserAddressesModel = {
    ...
    createUserAddress: async (user_id, userData) => {
        const { address_line1, address_line2, city, post_code, country } = userData;
        try {
            const result = await pool.query('INSERT INTO user_addresses (user_id, address_line1, address_line2, city, post_code, country) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *', [user_id, address_line1, address_line2, city, post_code, country]);
    ...
    updateUserAddress: async (userId, updatedUserData) => {
        const { address_line1, address_line2, city, post_code, country } = updatedUserData;
        try {
            const result = await pool.query('UPDATE user_addresses SET address_line1 = $1, address_line2 = $2, city = $3, post_code = $4, country = $5 WHERE user_id = $6 RETURNING *', [address_line1, address_line2, city, post_code, country, userId]);
